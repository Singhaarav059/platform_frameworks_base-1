...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView(@Nullable RegisterStatusBarResult result) {
        ...
        filter.addAction(BlissUtils.ACTION_DISMISS_KEYGUARD);
    ...
    public void updateTileStyle() {
        ...
        BlissUtils.updateTileStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), qsTileStyle);
    }
    ...
    public void updateQSHeaderStyle() {
        ...
        BlissUtils.updateQSHeaderStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), qsHeaderStyle);
    }

    // Unload all qs header styles back to stock
    public void stockQSHeaderStyle() {
        BlissUtils.stockQSHeaderStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId());
    }
    ...
    public void updateSystemTheme() {
        ...
        switch(mSystemTheme) {
           case 0:
                ...
                BlissUtils.disableSystemTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), BlissUtils.MATERIAL_OCEAN);
           break;
           case 1:
           ...
           case 5:
                ...
                BlissUtils.disableSystemTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), BlissUtils.DARK_GREY);
                BlissUtils.disableSystemTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), BlissUtils.XTENDED_CLEAR);
                BlissUtils.enableSystemTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), BlissUtils.MATERIAL_OCEAN);
           break;
        }
    }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (BlissUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(BlissUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(BlissUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
        ...
        switch (key) {
            ...
            case FORCE_SHOW_NAVBAR:
                ...
                boolean mNavbarVisible =
                    TunerService.parseIntegerSwitch(newValue, BlissUtils.hasNavbarByDefault(mContext));;
